...
fn sample_zone(zone: &'static BodyZone, t: f64, breath_phase: f64) -> SignalSample {
    ...
    let phase_noise: f64 = rng.random_range(-0.1..=0.1);
    ...
    let scatter_noise: f64 = rng.random_range(0.0_f64..=(1.0_f64 / (k_factor + 1.0)).sqrt());
    let csi_magnitude: f64 = los_component + scatter_noise;
    let motion_variance: f64 = rng.random_range(0.0..=breath.abs() / 10.0_f64.max(1.0));
